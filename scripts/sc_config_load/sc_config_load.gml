...
//
option_state[opt_music]=40;
option_state[opt_sound]=50;
option_state[opt_autodeck]=true;
option_state[opt_dexnumber]=false;
...
if file_exists(config_file + file_format) {
	...
	if !is_undefined(ds_map_find_value(savemap,"dexnumber")) { option_state[opt_dexnumber]=ds_map_find_value(savemap,"dexnumber"); }
